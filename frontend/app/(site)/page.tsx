  ...
  return (
    <>
      <div className=" text-dark-gray pt-[64px] min-h-screen h-[calc( 100% - 64px )] w-full px-5 overflow-y-scroll scrollbar-hide">
        ...
        <HorizontalProductScroll isLoading={isLoading} label={"Our Products"} products={dataProducts.products} /> 
        ...
        <HorizontalProductScroll isLoading={isLoading} label={"Men"} products={dataProducts.products} /> 
        <HorizontalProductScroll isLoading={isLoading} label={"Jackets"} products={dataProducts.products} /> 
        <HorizontalProductScroll isLoading={isLoading} label={"T-shirts"} products={dataProducts.products} /> 
