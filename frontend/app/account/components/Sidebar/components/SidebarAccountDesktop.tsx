...
function SidebarAccountDesktop({routes}:SidebarAccountDesktopProps) {
    return (
        <div className="flex-[0.1] hidden lg:flex flex-col items-start  overflow-y-scroll rounded-lg scrollbar-hide  border-[0.05px] border-gray-300 bg-light-gray-transparent max-w-[500px]">
        {
