...
interface SidebarAccountMobileProps {
    routes:SidebarAccountRoute[]
    visible : boolean
    onClose : ()=>void
};

function SidebarAccountMobile({routes,visible,onClose}:SidebarAccountMobileProps) {
    return (
        <Drawer
            onClose={onClose}
            isOpen={visible}
        ...
        >
            ...
            <div className="flex flex-col items-start overflow-y-scroll rounded-lg scrollbar-hide  border-[0.05px] border-gray-300 bg-light-gray-transparent max-w-[500px]">
                {
